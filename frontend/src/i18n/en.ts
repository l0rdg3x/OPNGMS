...
export const en = {
  ...
  templates: {
    ...
    kindIdsPolicy: "Suricata/IDS policy",
    idsPolicy: {
      description: "Description (the policy identity)",
      enabled: "Enabled",
      prio: "Priority",
      action: "Match current action (rules whose action is one of these)",
      newAction: "New action",
      rulesets: "Rulesets the policy applies to",
      referenceDevice: "Reference device (to read the available rulesets)",
      load: "Load rulesets",
      loadHint: "Pick a device, then load its enabled rulesets to reference.",
      noDevice: "No device available in the active tenant to read rulesets from.",
      noRulesets: "No enabled rulesets found on the device (enable a ruleset first).",
      loadFailed: "Could not read the rulesets from the device.",
      ...
      note: "Referenced rulesets must already be enabled on the device. The rulesets/content "
        + "mapping is verified at runtime on apply.",
    },
    profiles: {
      tab: "Profiles",
      name: "Name",
  ...
  mfa: {
    ...
    passkeys: {
      title: "Passkeys",
      intro: "Register a passkey or security key to sign in without a code.",
      add: "Add passkey",
      ...
      removeConfirmBody: "This passkey will no longer be usable to sign in.",
      addedNotice: "Passkey added.",
      removedNotice: "Passkey removed.",
      addError: "Could not add the passkey. Please try again.",
      removeError: "Could not remove the passkey.",
      listError: "Failed to load passkeys",
      lastFactorError: "You can't remove your last second factor. Add another factor first.",
  ...
  errors: {
    ...
    retentionLoad: "Failed to load retention settings",
    retentionSave: "Failed to save retention settings",
  },
  system: {
    title: "System",
  ...
  perimeter: {
    title: "Perimeter",
    subtitle: "Attacker IPs at the firewall perimeter — failed logins to the box and blocked traffic.",
    failedLogins: "Failed logins",
    firewallBlocks: "Firewall blocks",
    failedLoginsHelp: "Login attempts to the box that were rejected.",
    firewallBlocksHelp: "Inbound traffic dropped by the firewall.",
    ip: "Source IP",
    country: "Country",
    user: "User",
    port: "Port",
  ...
  retention: {
    ...
    subtitle: "Override how long this tenant's data is kept. Leave a field empty to inherit the global default.",
    inheritHint: "Inherit global",
    save: "Save retention",
