...
TENANT_TABLES: list[str] = ["devices", "metrics", "alerts", "events", "config_snapshots", "config_changes", "report_settings", "generated_reports", "firmware_actions", "template_overrides", "report_schedule", "device_log_forwarding", "revoked_syslog_certs", "perimeter_attacker", "tenant_retention"]
